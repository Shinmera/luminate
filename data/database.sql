...
--
-- Host: localhost
-- Generation Time: Jul 28, 2012 at 10:00 PM
...
INSERT IGNORE INTO `bl_entries` (`entryID`, `FID`, `title`, `short`, `subject`, `tags`, `time`, `owner`) VALUES
...
(19, 1, 1, 'LOLDONGS', '', '!C.C./tYwhI', 'PENIS', '&gt;&gt;18\r\nFinally!', 1341927318, 1341927318, 'mMr4uFjQzmDundefined](9', '134192731821813.jpg', 'Code.Geass-.Lelouch.of.the.Rebellion.416898.jpg', '451x640', 96043, '127.0.0.1', 'p'),
...
(1, 1, 0, '', '', '!C.C./tYwhI', '', 'spoiler{penis}', 1341352091, 1341927318, 'mMr4uFjQzmDundefined](9', '134135209197876.jpg', 'cc014.jpg', '225x350', 115538, '127.0.0.1', 'l,p'),
...
(1, 2, 0, '', '', '!C.C./tYwhI', ':3', 'This thread has been moved to &gt;&gt;iou/2', 1341347952, 1341348295, 'mMr4uFjQzmDundefined](9', '134134795264113.jpg', 'cc037.jpg', '1920x1080', 110909, '127.0.0.1', ',l,rd');
...
('shinmera/misc', 'Things that just don&apos;t fit anywhere else.', '194,189,185,184,181,179,134,133,132,131,130,126,124,123,121,120,116,115,114,56,34,33,25,24,104,64'),
...
(129, 'shinmera/3D-CG', 'Cubes, They Keep Happening', 'Cubes are easy, quick and awesome.\r\nSo why the fuck not?', 1319972372, 'This,Shit,Always,Looks,Like,Portal,Doesn&#039;t,It', '1319972372-cubes_keep_happening.png', 'Shinmera'),
...
('Code', 'extra', 'code', 'code(){@}', 'deftag(code){\r\n  tag(code){tag(pre){print{content}}}\r\n}', 'Markup tag for code.', -1, NULL),
...
('chan_fileloc_extern', 'http://chan.linuz.com/Luminate/data/chan/', 's'),
...
('127.0.0.1', 1341008958, 'chan_post'),
